 ...
 */
class Version20170814174710 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    {
        $result = $this->connection->fetchAssoc('SHOW TABLES LIKE \'category_head\'');

        if ($result) {
            // if table found, then initial ecdb.sql file is already imported
            return;
        }
...
SQL
        ...
        $this->addSql(<<<SQL
            INSERT INTO `members` (`member_id`, `firstname`, `lastname`, `login`, `mail`, `passwd`, `admin`, `measurement`, `currency`) VALUES
            (1, 'Admin', 'Admin', 'admin', 'admin@mailen.com', :password, 1, 1, 'USD')
SQL
